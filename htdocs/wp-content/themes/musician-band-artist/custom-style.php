<?php
	...
	if($music_recording_studio_first_color != false){
		$music_recording_studio_custom_css .='.header-btn a, .seemore-btn a, .abt-cont i,.post-categories li a ,.post-categories li a:hover,.post-nav-links span,.post-nav-links a,.wp-block-button__link,.wp-block-tag-cloud a:hover{';
			$music_recording_studio_custom_css .='background: '.esc_attr($music_recording_studio_first_color).' !important;';
		$music_recording_studio_custom_css .='}';
	}
