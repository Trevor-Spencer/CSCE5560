            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  <?php if( get_theme_mod('musician_band_artist_slider_small_text_sec') != '' ){ ?>
                    <p class="small-title-slider"><?php echo esc_html(get_theme_mod('musician_band_artist_slider_small_text_sec'));?></p>
                  <?php }?>
                  ...
                  <?php if( get_theme_mod('musician_band_artist_slider_button_text','LEARN MORE') != ''){ ?>
                      <div class="more-btn mt-4 wow lightSpeedIn delay-1000" data-wow-duration="2s">              
                          <a href="<?php echo esc_url(get_theme_mod('music_recording_studio_top_button_url',false));?>"><i class="me-2 <?php echo esc_attr(get_theme_mod('musician_band_artist_slider_btn_icon', 'fas fa-play')); ?>"></i><?php echo esc_html(get_theme_mod('musician_band_artist_slider_button_text',__('LEARN MORE','musician-band-artist')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('musician_band_artist_slider_button_text',__('LEARN MORE','musician-band-artist')));?></span></a>
                      </div>
                  <?php } ?>
                </div>
              </div>
