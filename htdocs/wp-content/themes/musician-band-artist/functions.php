<?php
	...
	function musician_band_artist_customize_register($wp_customize) {
		...
		$wp_customize->remove_section( 'music_recording_studio_topbar_section' );

		$wp_customize->add_setting('musician_band_artist_slider_small_text_sec',array(
			'default'=> '',
			'sanitize_callback'	=> 'sanitize_text_field'
		));
		$wp_customize->add_control('musician_band_artist_slider_small_text_sec',array(
			'label'	=> __('Add Slider Button Text','musician-band-artist'),
			'input_attrs' => array(
	            'placeholder' => __( 'New Release', 'musician-band-artist' ),
	        ),
		...
		$wp_customize->add_setting('music_recording_studio_top_button_url',array(
			'default'	=> '',
			'sanitize_callback'	=> 'esc_url_raw'
		));
		$wp_customize->add_control('music_recording_studio_top_button_url',array(
			'label'	=> __('Add Button URL','music-recording-studio'),
			'section'	=> 'music_recording_studio_slidersettings',
			'setting'	=> 'music_recording_studio_top_button_url',
			'type'	=> 'url',
			'active_callback' => 'music_recording_studio_default_slider'
		));

		$wp_customize->add_setting('musician_band_artist_slider_btn_icon',array(
			'default'	=> 'fas fa-play',
			'sanitize_callback'	=> 'sanitize_text_field'
		));
		$wp_customize->add_control(new Music_Recording_Studio_Fontawesome_Icon_Chooser(
	        $wp_customize,'musician_band_artist_slider_btn_icon',array(
			'label'	=> __('Add Slider Button Icon','music-recording-studio'),
			'transport' => 'refresh',
			'section'	=> 'music_recording_studio_slidersettings',
			'setting'	=> 'musician_band_artist_slider_btn_icon',
			'type'		=> 'icon',
			'active_callback' => 'music_recording_studio_default_slider'
		)));
