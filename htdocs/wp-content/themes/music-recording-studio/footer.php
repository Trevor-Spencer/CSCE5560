        ...
        <?php if (get_theme_mod('music_recording_studio_copyright_hide_show', true)) {?>
            <div id="footer-2" class="pt-3 pb-3 text-center">
              	<div class="copyright container">
                    <p class="mb-0"><?php music_recording_studio_credit(); ?> <?php echo esc_html(get_theme_mod('music_recording_studio_footer_text',__('By VWThemes','music-recording-studio'))); ?></p>
