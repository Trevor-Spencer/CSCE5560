...
class Music_Recording_Studio_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Music_Recording_Studio_About_Widget',
			__('VW About us', 'music-recording-studio'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'music-recording-studio' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','music-recording-studio'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','music-recording-studio'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','music-recording-studio'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','music-recording-studio'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','music-recording-studio'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','music-recording-studio'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function music_recording_studio_about_custom_load_widget() {
	register_widget( 'Music_Recording_Studio_About_Widget' );
}
add_action( 'widgets_init', 'music_recording_studio_about_custom_load_widget' );