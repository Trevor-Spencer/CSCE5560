...
class Music_Recording_Studio_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'music-recording-studio' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $music_recording_studio_font_awesome_icon_array = music_recording_studio_font_awesome_icon_array();
                    foreach ($music_recording_studio_font_awesome_icon_array as $music_recording_studio_font_awesome_icon) {
                            $icon_class = $this->value() == $music_recording_studio_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($music_recording_studio_font_awesome_icon).'"></i>
                            <span class="music-recording-studio-social-class">'.esc_attr($music_recording_studio_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function music_recording_studio_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'music-recording-studio-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'music_recording_studio_customizer_script' );

if(!function_exists('music_recording_studio_font_awesome_icon_array')){
    function music_recording_studio_font_awesome_icon_array(){
