...
function music_recording_studio_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('music_recording_studio_logo_width',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
		));
	$wp_customize->add_control('music_recording_studio_logo_width',array(
		'label'	=> __('Logo Width','music-recording-studio'),
	...
	$wp_customize->add_setting('music_recording_studio_logo_height',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('music_recording_studio_logo_height',array(
		'label'	=> __('Logo Height','music-recording-studio'),
		'description'	=> __('Enter a value in pixels. Example:20px','music-recording-studio'),
		'input_attrs' => array(
    	'placeholder' => __( '10px', 'music-recording-studio' ),),
		'section'=> 'title_tagline',
	...
	$wp_customize->add_setting('music_recording_studio_site_title_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'music_recording_studio_site_title_color', array(
		'label'    => __('Site Title Color', 'music-recording-studio'),
		'section'  => 'title_tagline',
		'active_callback' => 'music_recording_studio_logo_title_hide_show'
	)));
	...
	$wp_customize->add_setting('music_recording_studio_site_tagline_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'music_recording_studio_site_tagline_color', array(
		'label'    => __('Site Tagline Color', 'music-recording-studio'),
		'section'  => 'title_tagline',
		'active_callback' => 'music_recording_studio_tagline_hide_show'
	)));
}
