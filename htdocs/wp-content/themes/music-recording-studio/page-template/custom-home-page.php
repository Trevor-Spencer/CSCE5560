...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'music_recording_studio_slider_hide_show', false) == 1 || get_theme_mod( 'music_recording_studio_resp_slider_hide_show', true) == 1) { ?>
    <section id="slider"> 
    <?php if(get_theme_mod('music_recording_studio_slider_type', 'Default slider') == 'Default slider' ){ ?>       
      <div id="carouselExampleInterval" class="carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod( 'music_recording_studio_slider_speed',4000)) ?>">
        ...
        <?php if(get_theme_mod('music_recording_studio_slider_arrow_hide_show', true)){?>
          <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleInterval" id="prev" data-bs-slide="prev">
          <i class="<?php echo esc_attr(get_theme_mod('music_recording_studio_slider_prev_icon','fas fa-arrow-left')); ?>"></i>
          ...
          <i class="<?php echo esc_attr(get_theme_mod('music_recording_studio_slider_next_icon','fas fa-arrow-right')); ?>"></i>
